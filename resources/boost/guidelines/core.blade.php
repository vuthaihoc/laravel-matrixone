...
- String `=` comparisons and unique indexes are case-sensitive even on `_ci` collations. Normalize values such as e-mails and usernames (for example lower-case them in a mutator) before saving and before querying.
